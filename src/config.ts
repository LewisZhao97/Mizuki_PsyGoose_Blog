...
export const siteConfig: SiteConfig = {
	title: "PsyGoose",
	subtitle: "TA Blog",
	siteURL: "https://psygooseblog.vercel.app/", // 请替换为你的站点URL，以斜杠结尾
	...
	banner: {
		...
		homeText: {
			...
			title: "Technique For Art!", // 主页横幅主标题
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "This blog records my technical works in game engines.", // 公告内容
...
export const pioConfig: import("./types/config").PioConfig = {
	enable: true, // 启用看板娘
	models: ["/pio/models/pio/hijiki.model.json"], // 默认模型路径
	...
	dialog: {
		...
		link: "https://github.com/LewisZhao97", // 关于链接
	},
};
